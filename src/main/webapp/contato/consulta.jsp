	...
	<div class="container">
		<div class="jumbotron">
			...
			<table>
				...
				<tr align="left">
					<td><input id="contatoschk" name="contatoschk" type="checkbox" value="${contato}"></td>
			...
			<a href="controller.do?op=excctt&" class="form-control btn-danger" onClick="return confirm('Deseja realmente deletar os artigos selecionados?')">Excluir</a>
